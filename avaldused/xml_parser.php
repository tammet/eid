 ...
 * xml_parser.php
 *
 * @(#) $Header: /home/mlemos/cvsroot/xmlparser/xml_parser.php,v 1.23 2009/06/06 08:45:35 mlemos Exp $
 *
 */
...
class xml_parser_class
{
	...
	var $store_positions=0;
	var $case_folding=0;
	var $target_encoding="UTF-8";//"ISO-8859-1";
	var $simplified_xml=0;
	var $fail_on_non_simplified_xml=0;
...
Function XMLParseFile(&$parser,$file,$store_positions,$cache="",$case_folding=0,$target_encoding="UTF-8"/*"ISO-8859-1"*/,$simplified_xml=0,$fail_on_non_simplified_xml=0)
{
	if(strcmp($cache,""))
	{
